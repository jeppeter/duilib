...
#define  DUILIB_T_DEBUG(fmt,...) Duilib_TDebugOutString(DUILIB_DEBUG_LEVEL,__FILE__,__LINE__,fmt,__VA_ARGS__)
#define  DUILIB_T_ERROR(fmt,...) Duilib_TDebugOutString(DUILIB_ERROR_LEVEL,__FILE__,__LINE__,fmt,__VA_ARGS__)
...
#define  DUILIB_T_BUFFER(ptr,blen) Duilib_TDebugBufferFmt(DUILIB_DEBUG_LEVEL,__FILE__,__LINE__,(unsigned char*)ptr,blen,NULL)
#define  DUILIB_T_BUFFER_FMT(ptr,blen,...) Duilib_TDebugBufferFmt(DUILIB_DEBUG_LEVEL,__FILE__,__LINE__,(unsigned char*)ptr,blen,__VA_ARGS__)
